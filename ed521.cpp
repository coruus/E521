...
static const u6 bot58bits = 0x3ffffffffffffff;
static const u6 bot52bits = 0xfffffffffffff;
...
void gsqr(u6 *x,u6 *z)
{
  ...
  t1 =  4 * (  (u7)x[4]*x[8]
      ...
      + 2 * (  (u7)x[0]*x[3]
             ...
             + (t2 >> 58);
  z[3]=((u6) t1)&bot58bits;
  t2=4*((u7)x[5]*x[8]+(u7)x[6]*x[7])+2*((u7)x[0]*x[4]+(u7)x[1]*x[3])+(u7)x[2]*x[2]+(t1>>58);
  z[4]=((u6) t2)&bot58bits;
  t1=4*(u7)x[6]*x[8]+2*((u7)x[0]*x[5]+(u7)x[1]*x[4]+(u7)x[2]*x[3]+(u7)x[7]*x[7])+(t2>>58);
  z[5]=((u6) t1)&bot58bits;
  t2=4*(u7)x[7]*x[8]+2*((u7)x[0]*x[6]+(u7)x[1]*x[5]+(u7)x[2]*x[4])+(u7)x[3]*x[3]+(t1>>58);
  z[6]=((u6) t2)&bot58bits;
  t1=2*((u7)x[0]*x[7]+(u7)x[1]*x[6]+(u7)x[2]*x[5]+(u7)x[3]*x[4]+(u7)x[8]*x[8])+(t2>>58);
  z[7]=((u6) t1)&bot58bits;
  st0+=(t1>>58);
  z[8]=((u6)st0)&bot58bits;
  z[0]+=2*(u6)(st0>>58);
}

// z=2x^2

void gsqr2(u6 *x,u6 *z)
{
  u7 t0,t1,t2;
  u7 st0;
  t1=4*((u7)x[0]*x[8]+(u7)x[1]*x[7]+(u7)x[2]*x[6]+(u7)x[3]*x[5])   +(u7)x[4]*(2*x[4]);
  st0=((u6) t1)&bot58bits;
  t2=8*((u7)x[1]*x[8]+(u7)x[2]*x[7]+(u7)x[3]*x[6]+(u7)x[4]*x[5])   +2*((u7)x[0]*x[0]+(t1>>58));
  z[0]=((u6) t2)&bot58bits;
  t1=8*((u7)x[2]*x[8]+(u7)x[3]*x[7]+(u7)x[4]*x[6])     +4*((u7)x[0]*x[1]+(u7)x[5]*x[5])  +(t2>>58);
  z[1]=((u6) t1)&bot58bits;
  t2=8*((u7)x[3]*x[8]+(u7)x[4]*x[7]+(u7)x[5]*x[6])     +4*(u7)x[0]*x[2]+(u7)x[1]*(2*x[1])+(t1>>58);
  z[2]=((u6) t2)&bot58bits;
  t1=8*((u7)x[4]*x[8]+(u7)x[5]*x[7])      +4*((u7)x[0]*x[3]+(u7)x[1]*x[2]+(u7)x[6]*x[6])  +(t2>>58);
  z[3]=((u6) t1)&bot58bits;
  t2=8*((u7)x[5]*x[8]+(u7)x[6]*x[7])  +4*((u7)x[0]*x[4]+(u7)x[1]*x[3])  +(u7)x[2]*(2*x[2])  +(t1>>58);
  z[4]=((u6) t2)&bot58bits;
  t1=8*(u7)x[6]*x[8]  +4*((u7)x[0]*x[5]+(u7)x[1]*x[4]+(u7)x[2]*x[3]+(u7)x[7]*x[7])  +(t2>>58);
  z[5]=((u6) t1)&bot58bits;
  t2=8*(u7)x[7]*x[8]  +4*((u7)x[0]*x[6]+(u7)x[1]*x[5]+(u7)x[2]*x[4])  +(u7)x[3]*(2*x[3])  +(t1>>58);
  z[6]=((u6) t2)&bot58bits;
  t1=4*((u7)x[0]*x[7]+(u7)x[1]*x[6]+(u7)x[2]*x[5]+(u7)x[3]*x[4]+(u7)x[8]*x[8])  +(t2>>58);
  z[7]=((u6) t1)&bot58bits;
  st0+=(t1>>58);
  z[8]=((u6)st0)&bot58bits;
  z[0]+=2*(u6)(st0>>58);
...
void gmul(u6 *x, u6 *y, u6 *z)
{
  ...
  u7 st1= ((u6) t2) &bot58bits;

  t3 =  t0
      - (u7)(x[4]-2*x[5])*(y[4]-2*y[5])
      - (u7)(x[3]-2*x[6])*(y[3]-2*y[6])
      - (u7)(x[2]-2*x[7])*(y[2]-2*y[7])
      - (u7)(x[1]-2*x[8])*(y[1]-2*y[8])
      + 2*(t2>>58);
  z[0] = ((u6) t3)&bot58bits;
  ...
  t2 =  t0
      - (u7)(x[0]-  x[1])*(y[0]-  y[1])
      - (u7)(x[4]-2*x[6])*(y[4]-2*y[6])
      - (u7)(x[2]-2*x[8])*(y[2]-2*y[8])
      - (u7)(x[3]-2*x[7])*(y[3]-2*y[7])
      + (t3 >> 58);
  z[1] = ((u6)t2) & bot58bits;
  ...
  t3 =  t0
      - (u7)(x[0]-  x[2])*(y[0]-  y[2])
      - (u7)(x[5]-2*x[6])*(y[5]-2*y[6])
      - (u7)(x[3]-2*x[8])*(y[3]-2*y[8])
      - (u7)(x[4]-2*x[7])*(y[4]-2*y[7])
      + (t2>>58);
  z[2]=((u6)t3) & bot58bits;
  ...
  t2 =  t0 - 
        (u7)(x[0]-  x[3])*(y[0]-  y[3])
      - (u7)(x[1]-  x[2])*(y[1]-  y[2])
      - (u7)(x[4]-2*x[8])*(y[4]-2*y[8])
      - (u7)(x[5]-2*x[7])*(y[5]-2*y[7])
      + (t3>>58);
  z[3]=((u6)t2) & bot58bits;
  ...
  t3 =  t0 
      - (u7)(x[0]-  x[4])*(y[0]-  y[4])
      - (u7)(x[1]-  x[3])*(y[1]-  y[3])
      - (u7)(x[5]-2*x[8])*(y[5]-2*y[8])
      - (u7)(x[6]-2*x[7])*(y[6]-2*y[7])
      + (t2>>58);
  z[4]=((u6)t3) & bot58bits;
...
void double_2(ECp *P)
{
  u6 a[9],b[9],c[9],e[9],f[9],g[9],h[9];
  gsqr(P->x,a);
  gsqr(P->y,b); 
...
{
  u6 a[9],b[9],c[9],d[9],e[9],f[9],g[9],h[9];
  gmul(P->x, Q->x, a);
  gmul(P->y, Q->y, b);
  gmul(P->t, Q->t, c);
